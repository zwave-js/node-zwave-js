...
import { Constructable, Message } from "../message/Message";
...
export declare class SendDataRequest extends Message {
    ...
    callbackId: number;
    constructor();
    constructor(nodeId: number, cc: CommandClasses, ccPayload?: Buffer, transmitOptions?: TransmitOptions, callbackId?: number);
    serialize(): Buffer;
     ...
     */
    static isSendDataRequest(data: Buffer): boolean;
    /**
     * Extracts the command class from a serialized SendDataRequest
     * It is assumed that the buffer has been checked beforehand
     */
    static extractCommandClass(data: Buffer): CommandClasses;
    /**
     * Retrieves the correct constructor for the SendData request in the given Buffer.
     * It is assumed that the buffer has been checked beforehand
     */
    static getConstructor(data: Buffer): Constructable<SendDataRequest>;
 ...
 */
export declare function getCommandClass<T extends Message>(messageClass: T): CommandClasses;
/**
 * Retrieves the function type defined for a Z-Wave message class
 */
export declare function getCommandClassStatic<T extends Constructable<SendDataRequest>>(classConstructor: T): CommandClasses;
/**
 * Looks up the command class constructor for a given command class type and function type
 */
export declare function getCCConstructor(cc: CommandClasses): Constructable<SendDataRequest>;
