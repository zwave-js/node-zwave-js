...
let ClimateControlScheduleCC = class ClimateControlScheduleCC extends CommandClass_1.CommandClass {
    ...
    serialize() {
        switch (this.ccCommand) {
            ...
            case ClimateControlScheduleCommand.Get:
                ...
                break;
            default:
                throw new ZWaveError_1.ZWaveError("Cannot serialize a ClimateControlSchedule CC with a command other than Get or Set", ZWaveError_1.ZWaveErrorCodes.CC_Invalid);
        }
    ...
    deserialize(data) {
        ...
        switch (this.ccCommand) {
            ...
            default:
                throw new ZWaveError_1.ZWaveError("Cannot deserialize a ClimateControlSchedule CC with a command other than Report", ZWaveError_1.ZWaveErrorCodes.CC_Invalid);
        }
    }
};
__decorate([
