...
import { getAPI, getCommandClass } from "./CommandClass";
...
export class CCAPI {
	public constructor(
		...
		protected readonly endpoint: ZWaveEndpointBase | VirtualEndpointBase,
	) {
	...
	protected assertPhysicalEndpoint(
		endpoint: ZWaveEndpointBase | VirtualEndpointBase,
	): asserts endpoint is ZWaveEndpointBase {
		if (endpoint.virtual) {
			throw new ZWaveError(
	...
	protected isSinglecast(): this is this & { endpoint: ZWaveEndpointBase } {
		return (
...
export class PhysicalCCAPI extends CCAPI {
	...
	protected declare readonly endpoint: ZWaveEndpointBase;
}
...
// // This type is auto-generated by maintenance/generateCCAPIInterface.ts
// // Do not edit it by hand or your changes will be lost
// export type CCInstanceToAPI<CC extends CommandClass> = [CC] extends [
// 	import("./AlarmSensorCC").AlarmSensorCC,
// ]
// 	? import("./AlarmSensorCC").AlarmSensorCCAPI
// 	: [CC] extends [import("./AssociationCC").AssociationCC]
// 	? import("./AssociationCC").AssociationCCAPI
// 	: [CC] extends [import("./AssociationGroupInfoCC").AssociationGroupInfoCC]
// 	? import("./AssociationGroupInfoCC").AssociationGroupInfoCCAPI
// 	: [CC] extends [import("./BarrierOperatorCC").BarrierOperatorCC]
// 	? import("./BarrierOperatorCC").BarrierOperatorCCAPI
// 	: [CC] extends [import("./BasicCC").BasicCC]
// 	? import("./BasicCC").BasicCCAPI
// 	: [CC] extends [import("./BatteryCC").BatteryCC]
// 	? import("./BatteryCC").BatteryCCAPI
// 	: [CC] extends [import("./BinarySensorCC").BinarySensorCC]
// 	? import("./BinarySensorCC").BinarySensorCCAPI
// 	: [CC] extends [import("./BinarySwitchCC").BinarySwitchCC]
// 	? import("./BinarySwitchCC").BinarySwitchCCAPI
// 	: [CC] extends [import("./CRC16CC").CRC16CC]
// 	? import("./CRC16CC").CRC16CCAPI
// 	: [CC] extends [import("./CentralSceneCC").CentralSceneCC]
// 	? import("./CentralSceneCC").CentralSceneCCAPI
// 	: [CC] extends [
// 			import("./ClimateControlScheduleCC").ClimateControlScheduleCC,
// 	  ]
// 	? import("./ClimateControlScheduleCC").ClimateControlScheduleCCAPI
// 	: [CC] extends [import("./ClockCC").ClockCC]
// 	? import("./ClockCC").ClockCCAPI
// 	: [CC] extends [import("./ColorSwitchCC").ColorSwitchCC]
// 	? import("./ColorSwitchCC").ColorSwitchCCAPI
// 	: [CC] extends [import("./ConfigurationCC").ConfigurationCC]
// 	? import("./ConfigurationCC").ConfigurationCCAPI
// 	: [CC] extends [import("./DoorLockCC").DoorLockCC]
// 	? import("./DoorLockCC").DoorLockCCAPI
// 	: [CC] extends [import("./DoorLockLoggingCC").DoorLockLoggingCC]
// 	? import("./DoorLockLoggingCC").DoorLockLoggingCCAPI
// 	: [CC] extends [import("./EntryControlCC").EntryControlCC]
// 	? import("./EntryControlCC").EntryControlCCAPI
// 	: [CC] extends [
// 			import("./FirmwareUpdateMetaDataCC").FirmwareUpdateMetaDataCC,
// 	  ]
// 	? import("./FirmwareUpdateMetaDataCC").FirmwareUpdateMetaDataCCAPI
// 	: [CC] extends [import("./HumidityControlModeCC").HumidityControlModeCC]
// 	? import("./HumidityControlModeCC").HumidityControlModeCCAPI
// 	: [CC] extends [
// 			import("./HumidityControlOperatingStateCC").HumidityControlOperatingStateCC,
// 	  ]
// 	? import("./HumidityControlOperatingStateCC").HumidityControlOperatingStateCCAPI
// 	: [CC] extends [
// 			import("./HumidityControlSetpointCC").HumidityControlSetpointCC,
// 	  ]
// 	? import("./HumidityControlSetpointCC").HumidityControlSetpointCCAPI
// 	: [CC] extends [import("./IndicatorCC").IndicatorCC]
// 	? import("./IndicatorCC").IndicatorCCAPI
// 	: [CC] extends [import("./IrrigationCC").IrrigationCC]
// 	? import("./IrrigationCC").IrrigationCCAPI
// 	: [CC] extends [import("./LanguageCC").LanguageCC]
// 	? import("./LanguageCC").LanguageCCAPI
// 	: [CC] extends [import("./LockCC").LockCC]
// 	? import("./LockCC").LockCCAPI
// 	: [CC] extends [
// 			import("./ManufacturerProprietaryCC").ManufacturerProprietaryCC,
// 	  ]
// 	? import("./ManufacturerProprietaryCC").ManufacturerProprietaryCCAPI
// 	: [CC] extends [import("./ManufacturerSpecificCC").ManufacturerSpecificCC]
// 	? import("./ManufacturerSpecificCC").ManufacturerSpecificCCAPI
// 	: [CC] extends [import("./MeterCC").MeterCC]
// 	? import("./MeterCC").MeterCCAPI
// 	: [CC] extends [
// 			import("./MultiChannelAssociationCC").MultiChannelAssociationCC,
// 	  ]
// 	? import("./MultiChannelAssociationCC").MultiChannelAssociationCCAPI
// 	: [CC] extends [import("./MultiChannelCC").MultiChannelCC]
// 	? import("./MultiChannelCC").MultiChannelCCAPI
// 	: [CC] extends [import("./MultiCommandCC").MultiCommandCC]
// 	? import("./MultiCommandCC").MultiCommandCCAPI
// 	: [CC] extends [import("./MultilevelSensorCC").MultilevelSensorCC]
// 	? import("./MultilevelSensorCC").MultilevelSensorCCAPI
// 	: [CC] extends [import("./MultilevelSwitchCC").MultilevelSwitchCC]
// 	? import("./MultilevelSwitchCC").MultilevelSwitchCCAPI
// 	: [CC] extends [import("./NoOperationCC").NoOperationCC]
// 	? import("./NoOperationCC").NoOperationCCAPI
// 	: [CC] extends [import("./NodeNamingCC").NodeNamingAndLocationCC]
// 	? import("./NodeNamingCC").NodeNamingAndLocationCCAPI
// 	: [CC] extends [import("./NotificationCC").NotificationCC]
// 	? import("./NotificationCC").NotificationCCAPI
// 	: [CC] extends [import("./PowerlevelCC").PowerlevelCC]
// 	? import("./PowerlevelCC").PowerlevelCCAPI
// 	: [CC] extends [import("./ProtectionCC").ProtectionCC]
// 	? import("./ProtectionCC").ProtectionCCAPI
// 	: [CC] extends [import("./SceneActivationCC").SceneActivationCC]
// 	? import("./SceneActivationCC").SceneActivationCCAPI
// 	: [CC] extends [
// 			import("./SceneActuatorConfigurationCC").SceneActuatorConfigurationCC,
// 	  ]
// 	? import("./SceneActuatorConfigurationCC").SceneActuatorConfigurationCCAPI
// 	: [CC] extends [
// 			import("./SceneControllerConfigurationCC").SceneControllerConfigurationCC,
// 	  ]
// 	? import("./SceneControllerConfigurationCC").SceneControllerConfigurationCCAPI
// 	: [CC] extends [import("./Security2CC").Security2CC]
// 	? import("./Security2CC").Security2CCAPI
// 	: [CC] extends [import("./SecurityCC").SecurityCC]
// 	? import("./SecurityCC").SecurityCCAPI
// 	: [CC] extends [import("./SoundSwitchCC").SoundSwitchCC]
// 	? import("./SoundSwitchCC").SoundSwitchCCAPI
// 	: [CC] extends [import("./SupervisionCC").SupervisionCC]
// 	? import("./SupervisionCC").SupervisionCCAPI
// 	: [CC] extends [import("./ThermostatFanModeCC").ThermostatFanModeCC]
// 	? import("./ThermostatFanModeCC").ThermostatFanModeCCAPI
// 	: [CC] extends [import("./ThermostatFanStateCC").ThermostatFanStateCC]
// 	? import("./ThermostatFanStateCC").ThermostatFanStateCCAPI
// 	: [CC] extends [import("./ThermostatModeCC").ThermostatModeCC]
// 	? import("./ThermostatModeCC").ThermostatModeCCAPI
// 	: [CC] extends [
// 			import("./ThermostatOperatingStateCC").ThermostatOperatingStateCC,
// 	  ]
// 	? import("./ThermostatOperatingStateCC").ThermostatOperatingStateCCAPI
// 	: [CC] extends [import("./ThermostatSetbackCC").ThermostatSetbackCC]
// 	? import("./ThermostatSetbackCC").ThermostatSetbackCCAPI
// 	: [CC] extends [import("./ThermostatSetpointCC").ThermostatSetpointCC]
// 	? import("./ThermostatSetpointCC").ThermostatSetpointCCAPI
// 	: [CC] extends [import("./TimeCC").TimeCC]
// 	? import("./TimeCC").TimeCCAPI
// 	: [CC] extends [import("./TimeParametersCC").TimeParametersCC]
// 	? import("./TimeParametersCC").TimeParametersCCAPI
// 	: [CC] extends [import("./UserCodeCC").UserCodeCC]
// 	? import("./UserCodeCC").UserCodeCCAPI
// 	: [CC] extends [import("./VersionCC").VersionCC]
// 	? import("./VersionCC").VersionCCAPI
// 	: [CC] extends [import("./WakeUpCC").WakeUpCC]
// 	? import("./WakeUpCC").WakeUpCCAPI
// 	: [CC] extends [import("./ZWavePlusCC").ZWavePlusCC]
// 	? import("./ZWavePlusCC").ZWavePlusCCAPI
// 	: never;
