...
export interface CCAPIs {
	...
	"Alarm Sensor": import("../../../zwave-js/src/lib/commandclass/AlarmSensorCC").AlarmSensorCCAPI;
	Association: import("../../../zwave-js/src/lib/commandclass/AssociationCC").AssociationCCAPI;
	"Association Group Information": import("../../../zwave-js/src/lib/commandclass/AssociationGroupInfoCC").AssociationGroupInfoCCAPI;
	"Barrier Operator": import("../../../zwave-js/src/lib/commandclass/BarrierOperatorCC").BarrierOperatorCCAPI;
	Basic: import("../../../zwave-js/src/lib/commandclass/BasicCC").BasicCCAPI;
	Battery: import("../../../zwave-js/src/lib/commandclass/BatteryCC").BatteryCCAPI;
	"Binary Sensor": import("../../../zwave-js/src/lib/commandclass/BinarySensorCC").BinarySensorCCAPI;
	"Binary Switch": import("../../../zwave-js/src/lib/commandclass/BinarySwitchCC").BinarySwitchCCAPI;
	"CRC-16 Encapsulation": import("../../../zwave-js/src/lib/commandclass/CRC16CC").CRC16CCAPI;
	"Central Scene": import("../../../zwave-js/src/lib/commandclass/CentralSceneCC").CentralSceneCCAPI;
	"Climate Control Schedule": import("../../../zwave-js/src/lib/commandclass/ClimateControlScheduleCC").ClimateControlScheduleCCAPI;
	Clock: import("../../../zwave-js/src/lib/commandclass/ClockCC").ClockCCAPI;
	"Color Switch": import("../../../zwave-js/src/lib/commandclass/ColorSwitchCC").ColorSwitchCCAPI;
	Configuration: import("../../../zwave-js/src/lib/commandclass/ConfigurationCC").ConfigurationCCAPI;
	"Door Lock": import("../../../zwave-js/src/lib/commandclass/DoorLockCC").DoorLockCCAPI;
	"Door Lock Logging": import("../../../zwave-js/src/lib/commandclass/DoorLockLoggingCC").DoorLockLoggingCCAPI;
	"Entry Control": import("../../../zwave-js/src/lib/commandclass/EntryControlCC").EntryControlCCAPI;
	"Firmware Update Meta Data": import("../../../zwave-js/src/lib/commandclass/FirmwareUpdateMetaDataCC").FirmwareUpdateMetaDataCCAPI;
	"Humidity Control Mode": import("../../../zwave-js/src/lib/commandclass/HumidityControlModeCC").HumidityControlModeCCAPI;
	"Humidity Control Operating State": import("../../../zwave-js/src/lib/commandclass/HumidityControlOperatingStateCC").HumidityControlOperatingStateCCAPI;
	"Humidity Control Setpoint": import("../../../zwave-js/src/lib/commandclass/HumidityControlSetpointCC").HumidityControlSetpointCCAPI;
	Indicator: import("../../../zwave-js/src/lib/commandclass/IndicatorCC").IndicatorCCAPI;
	Irrigation: import("../../../zwave-js/src/lib/commandclass/IrrigationCC").IrrigationCCAPI;
	Language: import("../../../zwave-js/src/lib/commandclass/LanguageCC").LanguageCCAPI;
	Lock: import("../../../zwave-js/src/lib/commandclass/LockCC").LockCCAPI;
	"Manufacturer Proprietary": import("../../../zwave-js/src/lib/commandclass/ManufacturerProprietaryCC").ManufacturerProprietaryCCAPI;
	"Manufacturer Specific": import("../../../zwave-js/src/lib/commandclass/ManufacturerSpecificCC").ManufacturerSpecificCCAPI;
	Meter: import("../../../zwave-js/src/lib/commandclass/MeterCC").MeterCCAPI;
	"Multi Channel Association": import("../../../zwave-js/src/lib/commandclass/MultiChannelAssociationCC").MultiChannelAssociationCCAPI;
	"Multi Channel": import("../../../zwave-js/src/lib/commandclass/MultiChannelCC").MultiChannelCCAPI;
	"Multi Command": import("../../../zwave-js/src/lib/commandclass/MultiCommandCC").MultiCommandCCAPI;
	"Multilevel Sensor": import("../../../zwave-js/src/lib/commandclass/MultilevelSensorCC").MultilevelSensorCCAPI;
	"Multilevel Switch": import("../../../zwave-js/src/lib/commandclass/MultilevelSwitchCC").MultilevelSwitchCCAPI;
	"No Operation": import("../../../zwave-js/src/lib/commandclass/NoOperationCC").NoOperationCCAPI;
	"Node Naming and Location": import("../../../zwave-js/src/lib/commandclass/NodeNamingCC").NodeNamingAndLocationCCAPI;
	Notification: import("../../../zwave-js/src/lib/commandclass/NotificationCC").NotificationCCAPI;
	Powerlevel: import("../../../zwave-js/src/lib/commandclass/PowerlevelCC").PowerlevelCCAPI;
	Protection: import("../../../zwave-js/src/lib/commandclass/ProtectionCC").ProtectionCCAPI;
	"Scene Activation": import("../../../zwave-js/src/lib/commandclass/SceneActivationCC").SceneActivationCCAPI;
	"Scene Actuator Configuration": import("../../../zwave-js/src/lib/commandclass/SceneActuatorConfigurationCC").SceneActuatorConfigurationCCAPI;
	"Scene Controller Configuration": import("../../../zwave-js/src/lib/commandclass/SceneControllerConfigurationCC").SceneControllerConfigurationCCAPI;
	"Security 2": import("../../../zwave-js/src/lib/commandclass/Security2CC").Security2CCAPI;
	Security: import("../../../zwave-js/src/lib/commandclass/SecurityCC").SecurityCCAPI;
	"Sound Switch": import("../../../zwave-js/src/lib/commandclass/SoundSwitchCC").SoundSwitchCCAPI;
	Supervision: import("../../../zwave-js/src/lib/commandclass/SupervisionCC").SupervisionCCAPI;
	"Thermostat Fan Mode": import("../../../zwave-js/src/lib/commandclass/ThermostatFanModeCC").ThermostatFanModeCCAPI;
	"Thermostat Fan State": import("../../../zwave-js/src/lib/commandclass/ThermostatFanStateCC").ThermostatFanStateCCAPI;
	"Thermostat Mode": import("../../../zwave-js/src/lib/commandclass/ThermostatModeCC").ThermostatModeCCAPI;
	"Thermostat Operating State": import("../../../zwave-js/src/lib/commandclass/ThermostatOperatingStateCC").ThermostatOperatingStateCCAPI;
	"Thermostat Setback": import("../../../zwave-js/src/lib/commandclass/ThermostatSetbackCC").ThermostatSetbackCCAPI;
	"Thermostat Setpoint": import("../../../zwave-js/src/lib/commandclass/ThermostatSetpointCC").ThermostatSetpointCCAPI;
	Time: import("../../../zwave-js/src/lib/commandclass/TimeCC").TimeCCAPI;
	"Time Parameters": import("../../../zwave-js/src/lib/commandclass/TimeParametersCC").TimeParametersCCAPI;
	"User Code": import("../../../zwave-js/src/lib/commandclass/UserCodeCC").UserCodeCCAPI;
	Version: import("../../../zwave-js/src/lib/commandclass/VersionCC").VersionCCAPI;
	"Wake Up": import("../../../zwave-js/src/lib/commandclass/WakeUpCC").WakeUpCCAPI;
	"Z-Wave Plus Info": import("../../../zwave-js/src/lib/commandclass/ZWavePlusCC").ZWavePlusCCAPI;
}
