import type { CommandClasses, ValueMetadata } from "@zwave-js/core";
...
type MergeMeta<TMeta extends CCValueMeta | undefined> = DropOptional<
...
export type CCValueMeta = Partial<ValueMetadata> & {
	/**
