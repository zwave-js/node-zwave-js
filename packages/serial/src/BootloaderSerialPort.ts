...
/** The default version of the Bootloader serial binding that works using node-serialport */
export class BootloaderSerialPort extends BootloaderSerialPortBase {
	constructor(port: string, Binding: typeof SerialPort = SerialPort) {
