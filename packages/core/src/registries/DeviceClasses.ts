...
const deviceClasses = Object.freeze(
	...
	} as const satisfies Record<number, GenericDeviceClassDefinition>,
);

/** Returns the Generic Device Class for the given key */
export function getGenericDeviceClass<Generic extends number>(
	generic: Generic,
): Generic extends keyof typeof deviceClasses ? typeof deviceClasses[Generic]
	: GenericDeviceClass
{
	...
	} satisfies GenericDeviceClass as any;
}
...
export function getSpecificDeviceClass<
	...
	Specific extends number,
>(
	generic: Generic,
	specific: Specific,
): Generic extends keyof typeof deviceClasses
	? Specific extends keyof typeof deviceClasses[Generic]["specific"]
		? typeof deviceClasses[Generic]["specific"][Specific]
	: SpecificDeviceClass
	: SpecificDeviceClass
{
	const genericClass: GenericDeviceClassDefinition | undefined =
	...
	return {
		...
		maySupportBasicCC: specificClass.maySupportBasicCC
			...
			?? true,
	} satisfies SpecificDeviceClass as any;
}
