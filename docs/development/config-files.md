...
For devices that only slightly change between firmware versions or hardware revisions, you can enable some settings conditionally with the `"$if"` property. It accepts a string with logic inside, e.g.
