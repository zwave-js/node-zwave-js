...
export function encodeSetbackState(state: number | SetbackSpecialState): number {
...
export function decodeSetbackState(val: number): number | SetbackSpecialState | undefined {
	if (val > 120) {
